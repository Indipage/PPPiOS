...
final class MySavedArticleView: UIView {
    ...
    private let savedArticelNavigationBar = UIView()
    ...
    private func hieararchy() {
        self.addSubviews(savedArticelNavigationBar, savedArticleCollectionView)
        savedArticelNavigationBar.addSubviews(backButton, titleLabel)
    }
    
    private func layout() {
        savedArticelNavigationBar.snp.makeConstraints {
        ...
        savedArticleCollectionView.snp.makeConstraints {
            $0.top.equalTo(self.savedArticelNavigationBar.snp.bottom)
